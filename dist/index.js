...
var d = new _dialogue.Dialogue({ parent: (0, _helpers.qs)('body') });
...
var EventList = exports.EventList = function (_Hookable) {
  ...
  _createClass(EventList, [{
    key: 'add',
    value: function add() {
      var e = new Event({ parent: this.container, position: this._events.length });
...
var Event = exports.Event = function (_Hookable2) {
  ...
  function Event(options) {
    ...
    _this2.type = event_types[Math.floor(Math.random() * event_types.length)];
