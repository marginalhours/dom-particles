...
var _corpse = __webpack_require__(17);
...
var _itemSelect = __webpack_require__(18);
...
var _tileLoop = __webpack_require__(15);
...
var TileLoop = exports.TileLoop = function (_Hookable) {
  ...
  _createClass(TileLoop, [{
    ...
    key: 'add',
    value: function add() {
      var e = new Tile({ parent: this.container, position: this._tiles.length, card: new _creature2.default({ creature: (0, _creature3.getCreature)() }) });
    ...
    value: function addAtIndex(index) {
      var e = new Tile({ parent: this.container, position: 1, card: new _creature2.default({ creature: (0, _creature3.getCreature)() }) });
      e.inner.classList.add('spin1');
    ...
    value: function push(c) {
      var e = new Tile({ parent: this.container, position: this._tiles.length, card: c });
      e.inner.classList.add('spin1');
    ...
    value: function pop(idx) {
      ...
      idx = idx || 0;
      var m = this._tiles.splice(this.pointer + idx, 1)[0];
      this.reposition();
      m.destroy();
      return m;
    }
    ...
    value: function unshift(c) {
      ...
      var e = new Tile({ parent: this.container, position: this.pointer, card: c });
      e.inner.classList.add('spin1');
...
var Tile = exports.Tile = function (_Hookable2) {
  ...
  function Tile(options) {
    ...
    var _this3 = _possibleConstructorReturn(this, (Tile.__proto__ || Object.getPrototypeOf(Tile)).call(this, {
      parent: parent,
  ...
  _createClass(CorpseCard, [{
    ...
    value: function enter(stack) {
      ...
      options.push({
        ...
        callback: function callback() {
          stack.pop();
          stack.unshift(new _corridor2.default());
      ...
      Object.keys(_player2.default.items).map(function (k) {
        if (_player2.default.items[k].count > 0) {
          options.push({
            ...
            callback: function callback() {
              stack.pop();
              stack.unshift(new _target2.default({
                item: k,
