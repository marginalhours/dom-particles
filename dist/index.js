...
"use strict";
throw new Error("Module build failed: SyntaxError: Unexpected token, expected , (59:59)\n\n  57 |           dynamicStyles[styleKey] = { unit: k[0][1], values: k.map(v => v[0])};  \n  58 |         } else {\n> 59 |           dynamicStyles[styleKey] = { unit: '', values: [k }  \n     |                                                            ^\n  60 |         }\n  61 |       } else if (typeof styleValue === 'object') {\n  62 |         // I guess...?           \n");
