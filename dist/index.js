...
exports.CharacterSheet = exports.CreatureCard = exports.TargetCard = exports.ItemSelectCard = exports.CorpseCard = exports.Card = undefined;
...
var CharacterSheet = exports.CharacterSheet = function (_Card5) {
  _inherits(CharacterSheet, _Card5);
...
(0, _helpers.qs)('.player-image').addEventListener('click', function () {
  if (!(s.peek().card instanceof _cards.CharacterCard)) {
    s.unshift(new _cards.CharacterCard());
  }
});
